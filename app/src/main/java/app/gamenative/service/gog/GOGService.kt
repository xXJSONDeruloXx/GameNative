...
class GOGService : Service() {
    ...
    companion object {
        private val ACTION_SYNC_LIBRARY = app.gamenative.AppPaths.getScopedAction("GOG_SYNC_LIBRARY")
        private val ACTION_MANUAL_SYNC = app.gamenative.AppPaths.getScopedAction("GOG_MANUAL_SYNC")
