...
data class ContainerData(
    ...
    val steamSelectedLaunchSignature: String = "",
    val steamTransientLaunchSelection: Boolean = false,
        ...
        val Saver = mapSaver(
            save = { state ->
                mapOf(
                    ...
                    "steamSelectedLaunchSignature" to state.steamSelectedLaunchSignature,
                    "steamTransientLaunchSelection" to state.steamTransientLaunchSelection,
            ...
            restore = { savedMap ->
                ContainerData(
                    ...
                    steamSelectedLaunchSignature = (savedMap["steamSelectedLaunchSignature"] as? String) ?: "",
                    steamTransientLaunchSelection = (savedMap["steamTransientLaunchSelection"] as? Boolean) ?: false,
