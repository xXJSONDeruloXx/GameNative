...
| `gn-native-layer` | 28 | Complete Vulkan layer with documentation, tooling, and APK bundling support | ✅ |
| `feat/gamescope-vk-experiment` | 7 | GameNative integration with independent settings, UI, and launcher integration | ✅ |
